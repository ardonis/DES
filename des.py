def expansion(inp):
    ...
    cyclecount = int(0)
    for x in STable:
        outnum[cyclecount] = inp[x]
        cyclecount = cyclecount+1

    return outnum


""" print("".join(expansion("qwertzuiopőúasdfghjkléáűíyxcvbnm1234")))
print(len("".join(expansion("qwertzuiopőúasdfghjkléáűíyxcvbnm1234")))) """
